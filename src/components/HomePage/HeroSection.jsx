    ...
    <div className="hero-lg w-full bg-orange-300 py-6 !mx-0 px-4 sm:py-8 sm:px-6 lg:py-10 lg:px-5">
      ...
      <div className="hero-grid grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 gap-4 mb-6 sm:mb-8 lg:mb-10">
        ...
        <div className="flex flex-row gap-4 flex-wrap sm:flex-col">
          {/* Top solid card */}
          <div className="bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-md transition flex-1 flex flex-col min-w-[150px]">
            <img
          ...
          {/* Bottom image card */}
          <div className="bg-orange-200 rounded-xl flex flex-col justify-center items-center text-center p-4 sm:p-6 flex-1 min-w-[150px]">
        ...
        {/* Right big card */}
        <div className="bg-orange-100  rounded-lg text-center flex-1 m-2 sm:m-2.5">
          <img
            src="/images/men2.png"
            alt="Simplicity Blouse"
      ...
      <div className="text-center max-w-xl sm:max-w-2xl lg:max-w-3xl mx-auto">
        ...
        <button className="mt-4 sm:mt-6 bg-orange-400 hover:bg-orange-500 text-white font-semibold py-2 sm:py-3 px-6 sm:px-8 rounded-full transition text-sm sm:text-base">
          Shop Now →
        </button>
      </div>
    </div>
